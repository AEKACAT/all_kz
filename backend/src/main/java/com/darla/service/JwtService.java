...
public class JwtService {
	...
	public String generateToken(String username, Long expiration) {
		...
		return Jwts.builder()
				...
				.expiration(new Date(System.currentTimeMillis() + expiration)) // 1 күн мерзімді орнату
				.and().signWith(getKey())
	...
	private Claims extractAllClaims(String token) {
		...
		try {
			...
			throw new RuntimeException("Жарамсыз немесе мерзімі өткен токен. Қайта кіруді өтініңіз.");
		}
	}
