...
const Login = () => {
    ...
    const renderForgotPasswordForm = () => (
        <div className="max-w-sm w-full space-y-8 mt-20">
            {/* Header */}
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <input
                                    ...
                                    onChange={handleResetChange}
                                    className={`block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 ${resetData.confirmPassword && resetData.newPassword !== resetData.confirmPassword
                                        ? 'border-red-500'
                                        : 'border-gray-300'
                                        }`}
    ...
    const renderLoginForm = () => (
        <div className="max-w-sm w-full space-y-8 mt-20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        placeholder={t('login.emailEnter')}
                    />
                </div>
                ...
                {/* <div className="flex items-center justify-end">
                    <button
                        ...
                        className="text-sm text-[#303030] hover:underline cursor-pointer"
                    >
            ...
            <div className="text-center mt-4">
                <p className="text-sm text-gray-600">
                    {t('login.noAccount')}{' '}
                    <Link to="/register" className="text-[#303030] hover:underline font-medium">
